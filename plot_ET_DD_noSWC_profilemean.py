...
# Paths
# =========================
INPUT_FILE = Path("./fluxnet_model_output/DD/ET_summary/DD_combined_ET_summary.csv")
...
FIG_FILE = FIG_DIR / "DD_et_kge_box_profilemean.png"
STAT_FILE = STAT_DIR / "DD_et_kge_box_profilemean.csv"
...
MODEL_PAIRS = [
    {
        ...
        "right_col": "BBL_mSWC_profile_mean_KGE_prime",
    },
    {
        "group": "Medlyn",
        "left_label": "noSWC",
        ...
        "right_col": "Medlyn_mSWC_profile_mean_KGE_prime",
    },
    {
        "group": "RF-mSWC",
        "left_label": "noSWC",
        ...
        "right_col": "RF_GPP_VPD_leaf_mSWC_profile_mean_KGE_prime",
    },
    {
        "group": "RF-SWC",
        "left_label": "noSWC",
        "right_label": "SWC",
        "left_col": "RF_GPP_VPD_leaf_noSWC_KGE_prime",
        "right_col": "RF_GPP_VPD_leaf_SWC_profile_mean_KGE_prime",
    },
]
...
def plot_boxplot_scatter(df: pd.DataFrame):
    ...
    for i, item in enumerate(MODEL_PAIRS):
        ...
        for j, s in enumerate([s_left, s_right]):
            ...
            x_jitter = rng.normal(loc=positions[j], scale=0.045, size=len(s))
            ax.scatter(
                x_jitter,
                s.values,
                s=16,
